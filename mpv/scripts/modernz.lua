...
local user_opts = {
    ...
    seekbarfg_color = "#00FF11",           -- color of the seekbar progress
    seekbarbg_color = "#999999",           -- color of the remaining seekbar
    seek_handle_color = "#000000",         -- color of the seekbar handle
    seek_handle_border_color = "#00FF11",  -- inner border color drawn inside the seekbar handle (set to "disable" to disable)
    ...
    hover_effect_color = "#00FF11",        -- color of a hovered button when hover_effect includes "color"
    ...
    nibble_color = "#00FF11",              -- color of chapter nibbles on the seekbar
